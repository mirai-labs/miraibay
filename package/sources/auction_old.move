module miraibay::auction_old {
    ...
    public fun new(
        ...
        // Lowest bid increment value should be 1 SUI.
        assert!(min_bid_increment > 1_000_000_000, 1);
    ...
    public fun bid(
        ...
        assert!(auction.winner.is_none(), EAuctionIsClosed);
